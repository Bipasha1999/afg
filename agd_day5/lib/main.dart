                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          makeItem(image: 'assets/two.jpg'),
                          makeItem(image: 'assets/three.jpg'),
                          makeItem(image: 'assets/four.jpg'),
      ...
      child: Container(
        ...
        child: SingleChildScrollView(
          ...
          children:<Widget>[
              ...
              SizedBox(height: 30,),
              Text("Golden Gate Bridge",style: TextStyle(color: Colors.grey[800],fontSize: 25,fontWeight: FontWeight.bold),),
      SizedBox(height: 10,),
      Align(
          alignment: Alignment.bottomRight,
          child: Icon(Icons.star_border,color: Colors.yellow,size: 30,),
      )
    ]
    ),
        ),
